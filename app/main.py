...
if "scored_documents" not in st.session_state:
    st.session_state.scored_documents = []
...
if user_input:
    ...
    if st.session_state.vector_store is not None:
        st.session_state.scored_documents = retrieve_documents(
    ...
    elif not st.session_state.scored_documents:
        assistant_response = (
